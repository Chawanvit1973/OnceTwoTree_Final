        ...
        public void DrawGameplay()
        {
            ...
            foreach (IEntity entity in _entities)
            {
                ...
                if (openConfig2)
                {
                    ...
                    spriteBatch.DrawString(font, "Throwstate = " + (playerInstance2.myhook._ishooking), new Vector2(_panelPos2.X + 270, _panelPos2.Y + 290), Color.Black);
                    spriteBatch.DrawString(font, "Throwstate = " + (HookBox._Hookboxes[1]._ishooking), new Vector2(_panelPos2.X + 270, _panelPos2.Y + 270), Color.Black);
